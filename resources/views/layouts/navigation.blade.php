        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    class="relative inline-flex items-center px-3 text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                        ...
                        @if(isset($notificationsCount) && $notificationsCount > 0)
                            ...
                            <span class="absolute -top-1 -right-2 bg-red-600 text-white text-xs font-bold rounded-full px-2">
